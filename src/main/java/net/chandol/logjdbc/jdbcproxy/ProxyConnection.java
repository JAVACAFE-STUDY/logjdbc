...
public class ProxyConnection implements Connection {
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        ...
        try {
            return new ProxyPreparedStatement(context, _connection.prepareStatement(sql));
        } catch (SQLException e) {
            context.printLog();
            throw e;
        }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        LogContext context = LogContext.of(config, sql);
        try {
            return new ProxyPreparedStatement(context, _connection.prepareStatement(sql, resultSetType, resultSetConcurrency));
        } catch (SQLException e) {
            context.printLog();
            throw e;
        }
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        LogContext context = LogContext.of(config, sql);
        try {
            return new ProxyPreparedStatement(context, _connection.prepareStatement(sql, autoGeneratedKeys));
        } catch (SQLException e) {
            context.printLog();
            throw e;
        }
    ...
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        LogContext context = LogContext.of(config, sql);
        try {
            return new ProxyPreparedStatement(context, _connection.prepareStatement(sql, columnIndexes));
        } catch (SQLException e) {
            context.printLog();
            throw e;
        }
    ...
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        LogContext context = LogContext.of(config, sql);
        try {
            return new ProxyPreparedStatement(context, _connection.prepareStatement(sql, columnNames));
        } catch (SQLException e) {
            context.printLog();
            throw e;
        }
